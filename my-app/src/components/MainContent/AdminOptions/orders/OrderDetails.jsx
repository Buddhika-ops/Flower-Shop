          ...
          <div className="p-4 mb-6 rounded-lg bg-gray-50">
            <div className="grid grid-cols-2 gap-4 mb-4">
              <div>
                ...
                <p className="text-sm"><span className="font-medium">Optional message:</span> {orderInfo?.special_instructions || 'N/A'}</p>
              ...
              <div>
                ...
                <p className="text-sm"><span className="font-medium">Address:</span> {orderInfo?.address || 'N/A'}</p>
                <p className="text-sm"><span className="font-medium">City:</span> {orderInfo?.city || 'N/A'}</p>
                <p className="text-sm"><span className="font-medium">Postal code:</span> {orderInfo?.postal_code || 'N/A'}</p>
              </div>
            </div>
          </div>
        )}
              ...
              {orderItems.map((item) => (
                ...
                >
                  <div className="flex items-start space-x-4">
                    <img
                      src={item.product?.image_url || 'https://via.placeholder.com/64x64?text=No+Image'}
